...
export const metadata: Metadata = {
  title: "Next.js Modale | TailAdmin - Next.js Dashboard-Vorlage",
  description:
    "Dies ist die Next.js Modale-Seite für TailAdmin - Next.js Tailwind CSS Admin Dashboard-Vorlage",
  // other metadata
};
...
export default function Modals() {
  return (
    <div>
      <PageBreadcrumb pageTitle="Modale" />
