...
import { PaymentStatus } from "@/data/paymentData"; // Import PaymentStatus

export type FilterColumn = keyof Payment | '';
...
export default function ZahlungenPage() {
  ...
  const [activeStatusFilter, setActiveStatusFilter] = useState<PaymentStatus | ''>(''); // Add activeStatusFilter state
  ...
  const handleStatusFilterClick = (status: PaymentStatus) => {
  ...
  const columns: { value: FilterColumn; label: string }[] = [
    ...
    { value: 'newDueDate', label: 'Neues Fälligkeitsdatum' },
  ];
  ...
  return (
    <div>
      <PageBreadcrumb pageTitle="Buchhaltung / Zahlungen" />
      <div className="min-h-screen rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div className="px-5 py-7 xl:px-10 xl:py-12">
          <div className="mb-6 flex flex-col gap-4">
            {/* Top row: Add Filter Button and Allgemeine Suche */}
